...
function wp_tour_package_customizer_theme_info( $wp_customize ){
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'wp-tour-package' ) . ': </label><a href="' . esc_url( 'https://demo.rarathemes.com/tour-package/' ) . '" target="_blank">' . __( 'here', 'wp-tour-package' ) . '</a></span>';
